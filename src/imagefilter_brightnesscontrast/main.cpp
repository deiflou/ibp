...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.brightnesscontrast");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Brightness and Contrast"));
    info.insert("description", QObject::tr("Adjust levels of the image in an easy way"));
