...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.adaptivemanifoldfilter");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Adaptive Manifold Filter"));
    info.insert("description", QObject::tr("Smooth the image preserving hard edges"));
