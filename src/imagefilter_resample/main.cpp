...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.resample");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Resample"));
    info.insert("description", QObject::tr("Resample the image to a new size using the selected resampling interpolation mode"));
