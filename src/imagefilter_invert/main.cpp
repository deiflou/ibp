...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.invert");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Invert"));
    info.insert("description", QObject::tr("Invert one or more channels of the image"));
