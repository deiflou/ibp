...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.tvdenoising");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Total Variation Denoising"));
    info.insert("description", QObject::tr("Removes the noise from the image using a variational method"));
