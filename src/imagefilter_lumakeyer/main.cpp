...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.lumakeyer");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Luma Keyer"));
    info.insert("description", QObject::tr("Apply a matte to the image based on its luminance"));
