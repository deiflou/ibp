...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.autolevels");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Auto Levels"));
    info.insert("description", QObject::tr("Adjust the levels automatically"));
