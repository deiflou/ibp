...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.resize");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Resize"));
    info.insert("description", QObject::tr("Resize the image without resampling its data"));
