...
public:
    ...
    virtual const SplineInterpolatorKnots & knots() = 0;
    virtual const SplineInterpolatorKnot & knot(int i) = 0;
    virtual int size() = 0;
    ...
    virtual ExtrapolationMode floorExtrapolationMode() = 0;
    virtual ExtrapolationMode ceilExtrapolationMode() = 0;
