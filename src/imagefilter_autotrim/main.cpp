...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.autotrim");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Auto Trim"));
    info.insert("description", QObject::tr("Trims the image based on some luma or alpha threshold value"));
