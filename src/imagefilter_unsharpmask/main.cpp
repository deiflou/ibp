...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.unsharpmask");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Unsharp Mask"));
    info.insert("description", QObject::tr("Enhances the image by contrasting fine details"));
    info.insert("tags", QObject::tr("Sharpen"));
