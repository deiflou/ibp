...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.levels");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Levels"));
    info.insert("description", QObject::tr("Adjust the black, mid and white tones of the image"));
