...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.huesaturation");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Hue/Saturation/Lightness"));
    info.insert("description", QObject::tr("Change the color information of the image in the HSL space"));
