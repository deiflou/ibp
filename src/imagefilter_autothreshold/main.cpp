...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.autothreshold");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Auto Threshold"));
    info.insert("description", QObject::tr("Transforms the channels of the image into binary using an automatic threshold value"));
