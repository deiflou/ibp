...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.colorbalance");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Color Balance"));
    info.insert("description", QObject::tr("Correct the image tones by adding or subtracting a certain amount "
                                           "of the main color components"));
