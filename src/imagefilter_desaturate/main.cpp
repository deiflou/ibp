...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.desaturate");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Desaturate"));
    info.insert("description", QObject::tr("Removes the chroma information of the image"));
