...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.contrastpreservinggrayscale");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Contrast Preserving Grayscale"));
    info.insert("description", QObject::tr("Convert the image to grayscale preserving the contrast"));
