...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.dctdenoising");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("DCT Denoising"));
    info.insert("description", QObject::tr("Removes the noise from the image using discrete cosine transform "
                                           "thresholding"));
