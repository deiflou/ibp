...
extern "C" ANITOOLS_EXPORT QHash<QString, QString> getAnitoolsPluginInfo()
{
    ...
    info.insert("id", "anitools.imagefilter.colorboosting");
    info.insert("version", "0.1.0");
    info.insert("name", QObject::tr("Color Boosting"));
    info.insert("description", QObject::tr("Try to improve the color contrast of the image"));
